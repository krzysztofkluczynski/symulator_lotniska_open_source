...
int main() {
    ...
    // Interface interface(db); //domyslnie ta smulacja trwa od 01.05.2022 do 07.05.2022
    // bool run = true;
    // int choice;
    // while(interface.getCurrentDate() <= interface.getStopDate())
    // {
    //     try
    //     {
